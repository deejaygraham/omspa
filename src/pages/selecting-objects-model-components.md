...
## Str#26. "Feature, PD Objects, HI Objects" Strategy // selecting objects (model components)
...
## Str#27. "Select Windows: A First Cut" Strategy // selecting objects (model components)
...
## Str#28. "Select Logon Window" Strategy // selecting objects (model components)
...
## Str#29. "Select Setup Windows" Strategy // selecting objects (model components)
...
## Str#30. "Select Core Windows" Strategy // selecting objects (model components)
...
## Str#30a. "Select HI Windows for PD Transactions" Strategy // selecting objects (model components)
...
## Str#32. "Select DM Objects" Strategy // selecting objects (model components)
...
## Str#33. "Select Interacting Systems or Devices" Strategy // selecting objects (model components)
