...
## Str#43. "Duplicate Responsibilities" Strategy // selecting objects (consider and challenge)
...
## Str#44. "Reengineer with Objects" Strategy // selecting objects (consider and challenge)
...
## Str#45. "Useful Questions" Strategy // selecting objects (consider and challenge)
...
## Str#46. "More Than a Report" Strategy // selecting objects (consider and challenge)
...
## Str#47. "Way to Know" Strategy // selecting objects (consider and challenge)
...
## Str#48. "No Objects Mimicking What a Human Does" Strategy // selecting objects (consider and challenge)
...
## Str#49. "Different Human Interaction" Strategy // selecting objects (consider and challenge)
