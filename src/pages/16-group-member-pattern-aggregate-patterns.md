...
![Strpat00000020.gif](/img/Strpat00000020.gif)
...
**[](/16-group-member-pattern-aggregate-patterns.html)**[Patt#16.](/16-group-member-pattern-aggregate-patterns.html) "Group-Member" (again)
...
\- Also, when "group" or "member" is a participant, place, or specific item:
...
Related strategy: [Str#37.](/selecting-objects-reuse.html) "Select and Reuse a Group of Interacting Objects" Strategy
