...
## Str#14. "Select Participants" Strategy // selecting objects (pattern players)
...
## Str#16. "Select Tangible Things" Strategy // selecting objects (pattern players)
...
## Str#17. "Select Transactions" Strategy // selecting objects (pattern players)
...
## Str#18. "Select Associates" Strategy // selecting objects (pattern players)
...
## Str#19. "Select Items and Specific Items" Strategy // selecting objects (pattern players)
...
## Str#19a. "Separate Definition from Usage" Strategy // selecting objects (pattern players)
...
## Str#20. "Select Interacting Systems and Devices" Strategy // selecting objects (pattern players)
...
## Str#20a. "Add Outbound/Inbound Request" Strategy // selecting objects (pattern players)
...
## Str#21. "Select Collections of Objects" Strategy // selecting objects (pattern players)
...
## Str#22. "Select Container Objects" Strategy // selecting objects (pattern players)
...
## Str#23. "Select a Collection" Strategy // selecting objects (pattern players)
...
## Str#24. "Select the Smallest Applicable Collection "Strategy // selecting objects (pattern players)
